...
#endif
#include "nesl_rtw.h"
#include "Solar_4a74f551_1.h"
#include "Solar_4a74f551_1_gateway.h"
void Solar_4a74f551_1_gateway ( void ) { NeModelParameters modelparams = { (
NeSolverType ) 0 , 0.001 , 0.001 , 0.001 , 1 , 0 , ( NeModifyAbsTol ) 2 ,
0.001 , 0 , 0 , 0 , 0 , ( SscLoggingSetting ) 0 , 605808976 , 0 , } ;
...
, 1 , 1 , 0.0001 , 0 , 3 , 2 , 0 , 1 , ( NeLinearAlgebraChoice ) 0 , 0 , (
...
Solar_4a74f551_1_dae ( & dae , & modelparams , & solverparams ) ;
nesl_register_simulator_group ( "Solar/Solver Configuration_1" , 1 , & dae ,
