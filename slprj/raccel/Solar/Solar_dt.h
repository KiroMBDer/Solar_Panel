...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . lyw1jaszff ) , 0 , 0 , 18 } ,
{ ( char_T * ) ( & rtDW . b3j4dtgyry [ 0 ] ) , 0 , 0 , 6 } , { ( char_T * ) (
& rtDW . bipxskpt45 ) , 11 , 0 , 13 } , { ( char_T * ) ( & rtDW . lua3lh5sso
[ 0 ] ) , 10 , 0 , 4 } , { ( char_T * ) ( & rtDW . ealppa1yju ) , 6 , 0 , 1 }
, { ( char_T * ) ( & rtDW . ipwfflkpgw ) , 8 , 0 , 2 } } ; static
DataTypeTransitionTable rtBTransTable = { 6U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . irradiance
) , 0 , 0 , 5 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
